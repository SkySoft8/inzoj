...
@section('content')
<form class="gap-4 w-96 flex flex-col justify-between" method="POST" action="{{ route('trainerUser.loginCheck') }}" id="loginForm">
    @csrf
    <h2 class="text-center text-3xl font-extrabold">Вход в аккаунт тренера</h2>
    ...
    <div class="text-center flex flex-col items-center gap-1">
        <a href="./register" class="font-medium text-indigo-600">Регистрация аккаунта тренера</a>
